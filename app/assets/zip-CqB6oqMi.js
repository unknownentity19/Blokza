...
import{_ as p,s as f,d}from"./index--_a5l2ZB.js";import{buildExport as h}from"./export-B9UwCyEV.js";import"./vendor-DnQQq7lD.js";async function w(e){const{default:o}=await p(async()=>{const{default:t}=await import("./zip-DGXD5IHN.js").then(r=>r.j);return{default:t}},__vite__mapDeps([0,1])),{files:i,bytes:n}=h(e),s=new o;for(const t of i)s.file(t.path,t.content);s.file("README.txt",m(e,i.map(t=>t.path)));const l=await s.generateAsync({type:"blob",compression:"DEFLATE"}),a=`${f(e.name,"site")}.zip`;return d(a,l),{filename:a,files:i.length,bytes:n}}function m(e,o){const i=o.filter(n=>n.endsWith(".html"));return`${e.name}
